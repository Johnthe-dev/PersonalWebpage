...
/**
 * Trait to Validate a msSQL Date
 *
 * This trait will inject a private method to validate a msSQL style date (e.g., 2016-01-15 15:32:48.643216). It will
...
trait ValidateDate {
     ...
     * @throws \Exception if some other error occurs
     **/
    public static function publicValidateDateTime($newDateTime) : \DateTime {
        // base case: if the date is a DateTime object, there's no work to be done
        if(is_object($newDateTime) === true && get_class($newDateTime) === "DateTime") {
            return($newDateTime);
        }
