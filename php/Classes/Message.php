 ...
 * @package JohnTheDev
 *
 * Description: This class will hold the messages for JohnThe.dev.
 *
...
class Message implements \JsonSerializable {
     ...
     * @var UuidInterface $messageId
     */
    private UuidInterface $messageId;

    /**
     * Content for this message held in markdown-like form -not null, TEXT
     * @var string $messageContent
     */
    private string $messageContent;

    /**
     * date Message was created - not null, \DateTime
     * @var \DateTime|string $messageDate
     */
    private \DateTime|string $messageDate;
